...
package me.jeonwooyoung.recording;
...
public class Recoding {
    ...
    private final boolean useRecoder = true;

    // 플레이와 스탑 메서드

    public void playrecoding() throws IOException {
        // Create a context for the synthesizer.
        //synth = JSyn.createSynthesizer();
        //synth.setRealTime(false);
        //버튼을 누르면 -> playRecoder = true로 바꾼다
    ...
    private void stopRecoding() throws IOException {
        if (recorder != null) {
            recorder.stop();
            recorder.close();
        }
